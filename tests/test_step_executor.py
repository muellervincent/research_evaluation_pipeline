...
async def test_dispatch_assessment_groups_sequential(orchestrator):
    ...
    task_list = AssessmentTaskList(groups=[
        AssessmentGroup(group_name="G1", tasks=[AssessmentTask(question_id="Q1", question_text="T1")]),
    ...
    orchestrator.execute_assessment_synthesis = AsyncMock(side_effect=[
