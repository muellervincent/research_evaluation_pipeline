...
class DiagnosticItem(BaseModel):
    ...
    """
    question_id: str
    category: str = Field(description="A short, descriptive category (max 5 words) explaining the error, e.g., 'Model Hallucination', 'Ground Truth Error', 'Ambiguous Source Text'.")
    explanation: str = Field(description="Detailed diagnostic explanation comparing the model's logic, the ground truth, and the objective source text.")
